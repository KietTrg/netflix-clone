export const GET_NETFIX_ORIGINALS = "GET_NETFIX_ORIGINALS";
...
export const GET_HORRO_MOVIES = "GET_HORRO_MOVIES";
export const GET_ROMANCE_MOVIES = "GET_ROMANCE_MOVIES";
export const GET_DOCUMENTARIE_MOVIES = "GET_DOCUMENTARIE_MOVIES";
